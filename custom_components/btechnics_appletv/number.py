...
async def async_setup_entry(
    ...
    async_add_entities([BtechnicsLiveDuration(entry)])




class BtechnicsLiveDuration(NumberEntity):
    """Live stream popup duration for Apple TV."""


    _attr_has_entity_name = True
    _attr_name = "Live Duur"
    ...
    def __init__(self, entry: ConfigEntry) -> None:
        ...
        self._attr_unique_id = f"{DOMAIN}_live_duration"
        self._entry = entry
    ...
    async def async_added_to_hass(self) -> None:
        ...
        def state_received(msg):
            ...
            try:
                ...
                _LOGGER.warning("Ongeldige waarde voor live duur: %s", msg.payload)
